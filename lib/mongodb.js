...
(function() {
  ...
  MongoDBDriver = (function(_super) {
    ...
    MongoDBDriver.prototype._query = function(stmt, args, cb) {
      ...
      if (stmt.insert) {
        try {
          return this.inner.collection(stmt.insert).insert(stmt.args, {
            safe: true
          }, function(err, res) {
            if (err) {
              return cb(err);
        ...
        try {
          if (stmt.query instanceof Object) {
            return this.inner.collection(stmt.select).find(stmt.query || {}).toArray(function(err, recs) {
              if (err) {
                return cb(err);
              } else {
                return cb(null, recs);
            ...
            return this.inner.collection(stmt.select).find().toArray(function(err, recs) {
              if (err) {
                return cb(err);
              } else {
                return cb(null, recs);
        ...
        try {
          if (stmt.query instanceof Object) {
            return this.inner.collection(stmt.selectOne).find(stmt.query || {}).toArray(function(err, recs) {
              if (err) {
                return cb(err);
              } else {
                return cb(null, recs.length > 0 ? recs[0] : null);
              }
            });
          } else {
            return this.inner.collection(stmt.selectOne).find().toArray(function(err, recs) {
              if (err) {
                return cb(err);
              } else {
                return cb(null, recs.length > 0 ? recs[0] : null);
        ...
        try {
          return this.inner.collection(stmt.update).update(stmt.query || {}, {
            $set: stmt.$set
          }, {
            safe: true,
            multi: true
        ...
        try {
          return this.inner.collection(stmt["delete"]).remove(stmt.query, {
            safe: true
          }, function(err, res) {
            if (err) {
              return cb(err);
        ...
        try {
          return this.inner.collection(stmt.save).save(stmt.args, {
            safe: true
          }, function(err, res) {
            if (err) {
              return cb(err);
    ...
    MongoDBDriver.prototype.generateUpdate = function(table, rec) {};

    MongoDBDriver.prototype.generateDelete = function(table, rec) {};
