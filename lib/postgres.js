...
(function() {
  ...
  PostgresDriver = (function(_super) {
    ...
    PostgresDriver.prototype.valuesStmt = function(args, i) {
      var key, keys, newKey, stmt, val, vals;
      if (i == null) {
        i = 0;
      }
      keys = [];
    ...
    PostgresDriver.prototype.generateInsert = function(table, args) {
      ...
      stmts = args instanceof Array ? stmts = (function() {
        ...
        for (i = _i = 0, _len = args.length; _i < _len; i = ++_i) {
          arg = args[i];
          _results.push(this.valuesStmt(arg, i));
        }
        return _results;
      }).call(this) : [this.valuesStmt(args, 0)];
      columnText = '(' + ((function() {
