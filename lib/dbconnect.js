...
(function() {
  ...
  DBConnect = (function(_super) {
    ...
    DBConnect.prototype.update = function(tableName, obj, cb) {
      var query, res, table,
        _this = this;
      try {
        if (!this.schema) {
        ...
        res = table.make(obj);
        if (this.prepared.hasOwnProperty("" + tableName + "_Update")) {
          return this.query("" + tableName + "_Update", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, res);
          ...
          query = this.generateUpdate(table, res);
          return this.query(query, {}, function(err, results) {
            if (err) {
              return cb(err);
            } else {
