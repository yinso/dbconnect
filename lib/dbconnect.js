...
(function() {
  ...
  DBConnect = (function(_super) {
    ...
    DBConnect.prototype.insert = function(name, obj, cb) {
      var query, res, table,
        _this = this;
      try {
        if (!this.schema) {
        ...
        table = this.schema.hasTable(name);
        if (!table) {
          return cb(new Error("dbconnect:insert:unknown_table: " + name));
        }
        res = table.make(obj);
        if (this.prepared.hasOwnProperty("" + name + "_Insert")) {
          return this.query("" + name + "_Insert", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, res);
    ...
    DBConnect.prototype["delete"] = function(name, obj, cb) {
      var query, table,
        _this = this;
      try {
        if (!this.schema) {
        ...
        table = this.schema.hasTable(name);
        if (!table) {
          return cb(new Error("dbconnect:delete:unknown_table: " + name));
        }
        if (this.prepared.hasOwnProperty("" + name + "_Delete")) {
          return this.query("" + name + "_Delete", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, res);
    ...
    DBConnect.prototype.select = function(name, query, cb) {
      var table,
        _this = this;
      try {
        if (!this.schema) {
        ...
        table = this.schema.hasTable(name);
        if (!table) {
          return cb(new Error("dbconnect:select:unknown_table: " + name));
        }
        if (this.prepared.hasOwnProperty("" + name + "_Select")) {
          return this.query("" + name + "_Select", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, res);
