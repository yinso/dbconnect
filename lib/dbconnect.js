  ...
  DBConnect = (function(_super) {
    ...
    DBConnect.prototype.insert = function(tableName, obj, cb) {
      ...
      try {
        ...
        res = table.make(obj);
        if (this.prepared.hasOwnProperty("" + tableName + "_Insert")) {
          return this.query("" + tableName + "_Insert", res, function(err, results) {
            var rec;
            if (err) {
              return cb(err);
            } else {
              if (results instanceof Array) {
                return cb(null, (function() {
                  ...
                  for (_i = 0, _len = results.length; _i < _len; _i++) {
                    rec = results[_i];
                    _results.push(this.schema.makeRecord(this, tableName, rec));
                  }
                  return _results;
                }).call(_this));
              } else {
                return cb(null, _this.schema.makeRecord(_this, tableName, results));
              }
            }
          });
        } else {
    ...
    DBConnect.prototype["delete"] = function(tableName, obj, cb) {
      var query, table,
        _this = this;
      try {
        if (!this.schema) {
        ...
        if (this.prepared.hasOwnProperty("" + tableName + "_Delete")) {
          return this.query("" + tableName + "_Delete", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, res);
          ...
          query = this.generateDelete(table, obj);
    ...
    DBConnect.prototype.select = function(tableName, query, cb) {
      ...
      try {
        ...
        if (this.prepared.hasOwnProperty("" + tableName + "_Select")) {
          return this.query("" + tableName + "_Select", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
          ...
          return this.query(query, {}, function(err, results) {
            ...
            if (err) {
              ...
              return cb(null, (function() {
                ...
                for (_i = 0, _len = results.length; _i < _len; _i++) {
                  res = results[_i];
                  _results.push(this.schema.makeRecord(this, tableName, res));
                }
                return _results;
              }).call(_this));
            }
    ...
    DBConnect.prototype.selectOne = function(tableName, query, cb) {
      ...
      try {
        ...
        if (this.prepared.hasOwnProperty("" + tableName + "_Select")) {
          return this.query("" + tableName + "_SelectOne", res, function(err, results) {
            if (err) {
              return cb(err);
            } else {
              return cb(null, results);
          ...
          query = this.generateSelectOne(table, query);
          return this.query(query, {}, function(err, rec) {
            if (err) {
              return cb(err);
            } else if (!rec) {
              return cb(new Error("dbconnect.selectOne:no_record_returned#: " + (JSON.stringify(query))));
            } else {
              return cb(null, _this.schema.makeRecord(_this, tableName, rec));
            }
          });
        }
      } catch (e) {
